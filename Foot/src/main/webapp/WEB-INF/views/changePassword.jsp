...
<div class="box">
<h1 class="page-subheading">Change password</h1>
...
<form:input path="userPassword" class="form-control" type="password" id="email" name="email" value=""/>
<form:errors cssStyle="color: red;" path="userPassword"/>
</div>
</div>
</div>
<p class="submit">
<button type="submit" name="_eventId_submit" class="btn btn-default btn-md icon-right"><span>Change Password</span></button>
</p>
</fieldset>
</form:form>
</div>

...
<div class="clearfix">
<div class="col-md-4">
<b>Flat Number:</b></div><div class="col-md-8">${shippingAddress.flatNumber}</div>
<br /><br />
<div class="col-md-4">
<b>Street Address:</b></div><div class="col-md-8">${shippingAddress.streetAddress}</div>
<br /><br />
<div class="col-md-4">
<b>City :</b></div><div class="col-md-8">${shippingAddress.city}</div>
<br /><br />
<div class="col-md-4">
<b>State :</b></div><div class="col-md-8">${shippingAddress.state}</div>
<br /><br />
<div class="col-md-4">
<b>Country :</b></div><div class="col-md-8">${shippingAddress.country}</div>
<br /><br />
<div class="col-md-4">
<b>Pin-Code :</b></div><div class="col-md-8">${shippingAddress.zipCode}</div>
<br /><br />

...
<li class="address_company">${billingAddress.flatNumber}</li>
<li class="address_address1 address_address2">${billingAddress.streetAddress}</li>
<li class="address_city address_state_name address_postcode">${billingAddress.city}</li>
<li class="address_country_name">${billingAddress.state}</li>
<li class="address_phone">${billingAddress.country}</li>
<li class="address_phone_mobile">${billingAddress.zipCode}</li>

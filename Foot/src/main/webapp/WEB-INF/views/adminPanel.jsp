...
<tr ng-repeat="supplierList in supplierList | filter:testSupplier | orderBy:sortType:sortReverse">
<td style="text-align: center;">{{supplierList.supplierName}}</td>
<td style="text-align: center;">{{supplierList.supplierAddress}}</td>
<td style="text-align: center;"><a href="updateSupplier-{{supplierList.userDetail.userId}}" class="fa fa-plus"> Add</a></td>
</tr>
</table>
</div>
</div>

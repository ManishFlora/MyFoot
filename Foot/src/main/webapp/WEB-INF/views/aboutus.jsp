...
<div id="cms" class="cms cms-4 cms-about-us hide-left-column hide-right-column lang_en  one-column">
...
<h3 style="text-align:center;">Catering to your requirements, handling your needs with care</h3>
<p style="text-align:center;">Our store is more than just another average online retailer. We sell not only top quality products, but give our customers a positive online shopping experience. Forget about struggling to do everything at once: taking care of the family, running your business, walking your dog, cleaning the house, doing the shopping, etc. Purchase the goods you need every day or just like in a few clicks or taps, depending on the device you use to access the Internet. We work to make your life more enjoyable.<br><br><br></p>
<div class="border_bottom2">
<ul class="animateCount row"><li class="col-xs-4"><span class="count">14500</span>
<h3>Products available</h3>
</li>
<li class="col-xs-4"><span class="count">81</span>%
<h3>Clients come back</h3>
</li>
<li class="col-xs-4"><span class="count">10</span>mln
<h3>Site members</h3>
</li>
</ul></div>
<h1 style="text-align:center;">Store events</h1>
<div class="border_bottom2">
<ul class="row list-4"><li class="col-xs-4 fa fa-search">
<h3>For convenience of choice</h3>
...
<h3>Delivery products to all regions</h3>
...
<h3>The highest quality of products</h3>
...
<div class="bx-wrapper" style="max-width: 1200px; margin: 0px auto;"><div class="bx-viewport" style="width: 100%; overflow: hidden; position: relative; height: 331px;"><ul id="testimonials" style="width: 615%; position: relative; left: -3510px;"><li class="material-design-ico icon material-design-google125 bx-clone" style="float: left; list-style: none; position: relative; width: 1170px;">
...
<li class="material-design-ico icon material-design-google125" style="float: left; list-style: none; position: relative; width: 1170px;">
<p>Thank you again and again! I have experienced the fastest support ever. My order arrived on my door step the following day. Your team is always, friendly and very helpful. You managed to exceed my expectations!</p>
<h3>Virginia Ubert</h3>
</li>
<li class="material-design-ico icon material-design-google125" style="float: left; list-style: none; position: relative; width: 1170px;">
<p>Hi, guys! I want to thank you for my very very quick delivery and I just love my order… Your company efficient services and customer care are second to none! I am very happy! I will surely share my experience with my friends!</p>
<h3>SAM KROMSTAIN</h3>
</li>
<li class="material-design-ico icon material-design-google125" style="float: left; list-style: none; position: relative; width: 1170px;">
<p>Having the distressing experience with some online shops before decided to say ‘’THANK YOU” to all personnel of this store. You are not only friendly, but deliver really good products in the shortest possible terms. In a word, I am absolutely happy with my purchase and the service. Everything was perfect!</p>

...
var webFilesDir = "../bg/index.html";
var cgiFilesDir = "../cgi-bin/index.html";
...
jsBulletin("GET/dyn/bg/MTNL-FUPincrease/indexd55a.html?policy=52&amp;policyname=MTNL-FUPincrease&amp;time=1454501121&amp;webServer=http://203.94.227.140&amp;url=http%3A%2F%2Fwww.googletagmanager.com%2Fgtm.js%3Fid%3D%20HTTP/1.1");
...
function Bulletin()
{
   ...
   bgv_img = "FUPincrease.html";
   bgv_click = "Yes";
   bgv_url = "http://mtnlmumbai.in/index.php/broadband/triband/unlimited-plans";
   bgv_height = 300;
   bgv_delay = 4;
   bgv_duration = 1;
   bgv_timeout = 30;
        ...
        (function (window) {
            {
                ...
                // Other browsers
                else if ((nameOffset = nAgt.lastIndexOf(' ') + 1) < (verOffset = nAgt.lastIndexOf('../index.html'))) {
...
buttons.push(new button(bdivButton, 'click', imageClicked));
   ...
   makeButton("Close", "Close", "", "CloseButton.html");
